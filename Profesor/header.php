...
<div id="header">
    <div id="logged_in">
        <form id="j_id13" name="j_id13" method="post" action="<?php echo base_url('index.php/Profesor/profil')?>" enctype="application/x-www-form-urlencoded">
            <input type="hidden" name="j_id13" value="j_id13">

            <strong class="<?php if($_SESSION['pol']=="m" || $_SESSION['pol']=="M") echo "m"; else echo "z";?>">
            ...
            <a href="<?php echo base_url('index.php/Profesor/krajRada');?>" id="logout">kraj rada</a><input type="hidden" name="javax.faces.ViewState"
                                                                 value="j_id6">
        </form>
    </div>
